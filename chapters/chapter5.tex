...
\begin{table}[hbt]
  ...
  \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}m{2.8cm}*{6}{>{\centering\arraybackslash}X}}
    ...
    \midrule
    HONEST & 67.2 & 66.9 & 65.7 & 64.7 & 62.7 & 63.1 \\
    TWBias & 84.9 & 84.4 & 73.2 & 74.3 & 79.6 & 80.0 \\
    BiasGuard & 89.2 & \textbf{90.1} & 74.8 & 74.2 & 79.5 & 79.2 \\
...
\begin{table}[hbt]
  ...
  \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}m{2.8cm}*{6}{>{\centering\arraybackslash}X}}
    ...
    \cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
     & GPT-5.4 & Llama-Guard-3 & GPT-5.4 & Llama-Guard-3 & GPT-5.4 & Llama-Guard-3 \\
    \midrule
    HONEST & 70.0 & 69.6 & 63.9 & 65.2 & 62.0 & 62.1 \\
    TWBias & 80.1 & 80.1 & 88.0 & 87.7 & 76.6 & 76.6 \\
    BiasGuard & \textbf{82.0} & 81.6 & 84.5 & 84.4 & 77.7 & 76.4 \\
...
\begin{enumerate}[itemsep=0pt, topsep=2pt, parsep=0pt]
    ...
    \item Moral Self-Correction\cite{ganguli2023moralselfcorrection}：该方法通过在提示中显式加入避免偏见、歧视或有害输出等自然语言指令，引导模型在生成前进行基于指令遵循与 CoT 反思的自我校正，从而减少不公平或有害表达。
\end{enumerate}
...
本节对本文方法、Moral Self-Correction 和 Self-Debiasing 在偏见回复重写任务中的表现进行比较。
...
为进一步考察不同方法在风险降低程度与文本修改代价之间的平衡关系，图~\ref{fig:rewrite-efficiency-overview} 给出了三种方法的样本点分布与均值对比结果。其中，横轴表示编辑距离比例，纵轴表示风险降低程度。理想情况下，样本点应尽可能分布在左上区域，即以更小的编辑代价获得更明显的偏见风险缓解。
